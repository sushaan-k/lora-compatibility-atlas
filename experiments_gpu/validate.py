#!/usr/bin/env python3
"""Answer-token screening panel at m=8 (Mistral, Lots-of-LoRAs): the primary-table rerun on capability labels."""
...
from surfaces import (auroc, fit_jets, jet_value,  # noqa: E402
...
def cmd_analyze(args):
    ...
    try:
        ...
        from certify import build_reduced_jets
