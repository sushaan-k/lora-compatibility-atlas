"""Numeric verification of the pair-table counterexample (Proposition: pair scores do not determine triple scores"""
import json
...
def main():
    ...
    (od / "pairtable.json").write_text(json.dumps(out, indent=2))
