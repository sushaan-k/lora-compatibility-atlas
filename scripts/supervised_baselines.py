"""GBM + MLP atlas-free baselines on the Qwen m=50 panel under three
feature regimes: cold_start (arity + operator + slice), pair_aware
(+ realized pair-feasibility for triples), full_history (+ 50-dim
adapter one-hot). Leave-one-slice-out CV."""
