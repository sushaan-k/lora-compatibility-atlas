"""Per-operator (predicted, heldout) residual stats: Spearman, regression
slope, signed residual mean, fraction of events where atlas overestimates.
Used to explain the DARE-TIES vs Linear AUROC gap."""
