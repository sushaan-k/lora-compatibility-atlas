#!/usr/bin/env python3
"""Main figure for the fit-once answer-token index (three panels from real data): (a) fidelity, predicted vs meas"""
import json
import collections
import sys
...
from style import apply_style, BLUE, SKY, VERMILLION
